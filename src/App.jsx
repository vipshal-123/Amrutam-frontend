...
import Discovery from './pages/user/DoctorDiscovery'
import Dashboard from './pages/user/AppointmentDashboard'
import Reschedule from './pages/user/Reschedule'
import CreateOrganization from './pages/auth/Organization'
import OtpVerification from './pages/auth/OtpVerification'
import OrgOtpVerify from './pages/auth/OrgOtpVerify'
